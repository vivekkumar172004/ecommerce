...
//     fetch("http://localhost:3000/newarrival/getnewarrival",{method:"POST",body:JSON.stringify({category:"na"}),headers:{"content-type":"application/json"}})
...
function Newarrival() {
  ...
  useEffect(() => {
    console.log("Fetching data...");
    fetch("http://localhost:3000/products/create?tag=li")
      .then((response) => {
        if (!response.ok) {
